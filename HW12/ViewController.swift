...
class ViewController: UIViewController{
    ...
    lazy var realmCurWeather = realm.objects(RealmCurWeather.self)
            ...
            //show current weather
               ...
               // save current weather
                ...
                try! self.realm.write{
                    ...
                    self.realm.add(realmCurWeather)
                }
    ...
    override func viewDidLoad() {
        ...
        self.dailyResults = realm.objects(RealmDaily.self)
...
extension ViewController: UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return weather?.daily.count ?? dailyResults?.count ?? 0
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if ((weather?.daily.isEmpty) == nil){
            let data = self.dailyResults![indexPath.row] // saved weather
